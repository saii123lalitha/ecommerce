...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_xHAjUDO4CXppBW",
      key_secret: "gi2n6UclYsDLlg4rWC508ayw",
  ...
  return (
    <Layout >
      <div className="bg-gray-100 pt-5 pb-20" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
